        ...
        <div class="wrapper-page">
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                     <br/>
                        <h4 class="text-muted text-center font-size-18" style="color: maroon;"><b>Register</b></h4>
...
@csrf
    ...
    <div class="form-group mb-3 row">
        <div class="col-12">
            <input class="form-control" id="name" name="name" type="text" required="required" placeholder="Full Name ">
        </div>
    </div>
    <div class="form-group mb-3 row">
        <div class="col-12">
    ...
    <div class="form-group text-center row mt-3 pt-1">
        <div class="col-12">
            <button style="background-color: maroon; color: #fff;" class="btn btn-default w-100 waves-effect waves-light" type="submit">Register</button>
        </div>
    </div>
